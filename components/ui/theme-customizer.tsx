...
import { Theme, themes } from "@/lib/theme/themes";

import "@/components/ui/styles/mdx.css";
    ...
    <div className="flex items-center space-x-2">
      ...
      <div className="hidden md:flex">
        ...
        <Popover>
          ...
          <PopoverContent align="end" className="z-40 w-[340px] rounded-[0.5rem] bg-white p-6 dark:bg-zinc-950">
            <Customizer />
          </PopoverContent>
        </Popover>
      </div>
        ...
        <div className="space-y-1.5">
          <div className="flex w-full items-center">
            ...
            <Popover>
              ...
              <PopoverContent className="space-y-3 rounded-[0.5rem] text-sm" side="right" align="start" alignOffset={-20}>
                ...
                <p>
                  The <span className="font-medium">Default</span> style has larger inputs, uses lucide-react for icons and tailwindcss-animate for
                  animations.
                </p>
                <p>
                  The <span className="font-medium">New York</span> style ships with smaller buttons and cards with shadows. It uses icons from Radix
                  Icons.
                </p>
              </PopoverContent>
            </Popover>
